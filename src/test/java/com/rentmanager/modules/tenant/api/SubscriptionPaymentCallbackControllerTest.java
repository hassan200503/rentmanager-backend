...
import com.rentmanager.modules.tenant.api.controller.SubscriptionPaymentCallbackController;
...
@WebMvcTest(controllers = SubscriptionPaymentCallbackController.class)
@Import(SubscriptionPaymentCallbackControllerTest.PermitAllSecurityConfig.class)
class SubscriptionPaymentCallbackControllerTest {

    private static final String CALLBACK_BASE = "/api/v1/public/subscription-billing/mpesa/callback";
    ...
    @MockBean
    private SubscriptionPaymentCallbackService subscriptionPaymentCallbackService;
    ...
    @BeforeEach
    void setUp() {
        reset(darajaProperties, subscriptionPaymentCallbackService);
    }
    ...
    class SecretGating {
        ...
        void correctSecret_callsServiceAndReturns200() throws Exception {
            ...
            verify(subscriptionPaymentCallbackService).handle(any());
        }
        ...
        void wrongSecret_returns404_andDoesNotCallService() throws Exception {
            ...
            verify(subscriptionPaymentCallbackService, never()).handle(any());
        }
