...
import com.rentmanager.modules.property.application.command.usecase.MarkVacantUseCase;
...
public class PropertyMarkVacantCommandHandler implements MarkVacantUseCase {
    ...
    public void execute(UUID tenantId,
        ...
        propertyCommandService.markVacant(
                tenantId,
                propertyId
        );
    }
