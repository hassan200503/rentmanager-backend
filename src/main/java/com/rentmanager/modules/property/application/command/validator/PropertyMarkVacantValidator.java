...
public class PropertyMarkVacantValidator {
    ...
    public Property validate(UUID tenantId,
        ...
        if (property.getOccupancyStatus() == OccupancyStatus.VACANT) {
            throw new IllegalArgumentException("Property is already vacant");
        }
