...
public class MarkFullyOccupiedValidator {
    ...
    public Property validate(UUID tenantId,
        ...
        if (property.getOccupancyStatus() == OccupancyStatus.FULLY_OCCUPIED) {
            throw new IllegalArgumentException("Property is already fully occupied");
        }
