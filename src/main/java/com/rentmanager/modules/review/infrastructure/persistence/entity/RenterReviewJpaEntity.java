...
@Table(
        name = "renter_reviews",
        indexes = {
                @Index(name = "idx_renter_reviews_tenant_status", columnList = "tenant_id, status"),
                @Index(name = "idx_renter_reviews_status_created", columnList = "status, created_at")
        }
)
public class RenterReviewJpaEntity extends BaseTenantEntity {
